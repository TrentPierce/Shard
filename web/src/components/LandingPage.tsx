...
const pillars = [
    ...
    },
    {
        ...
        body: "Browsers now distinguish active WebGPU runtime support from the low-power ONNX/WebNN embeddings lane so Shard can compact and rank context before it touches the network.",
    },
]
        ...
        <main className="landing-modern" aria-label="Shard landing page">
            ...
            <section className="landing-modern__hero">
                ...
                <p className="landing-modern__lead">
                    ...
                    experimental WAN scout workflows available for benchmark research only while it expands a separate low-power browser contributor lane.
                </p>
