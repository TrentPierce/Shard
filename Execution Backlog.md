Execution Backlog (Epics, Tickets, Acceptance Criteria, Sequencing)
  ...
  - P1-T17: `Done` (browser capability profiling now drives explicit contribution status/reason in app context and start page UX; telemetry event emitted; WebLLM runtime initialization failures are now normalized into actionable browser guidance instead of raw internal FFI errors)
