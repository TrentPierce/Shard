Execution Backlog (Epics, Tickets, Acceptance Criteria, Sequencing)
  ...
  - P0-T13: `Partial` (service mode, silent install/uninstall, and rollback-safe backup implemented; code-signing pipeline still pending cert material)
  - P0-T14: `Partial` (first-run onboarding now includes identity/model dir prep, optional model acquisition, firewall and connectivity checks; GUI wizard UX still pending)
